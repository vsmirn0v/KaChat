...
// Typecheck with:
// DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer xcrun swiftc -sdk "$(DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer xcrun --sdk iphonesimulator --show-sdk-path)" -target arm64-apple-ios16.0-simulator -typecheck -parse-as-library KaChat/Utilities/ImagePrep.swift scripts/test_image_prep_avif_upload.swift
//
// Run on a booted simulator with:
// DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer xcrun swiftc -sdk "$(DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer xcrun --sdk iphonesimulator --show-sdk-path)" -target arm64-apple-ios16.0-simulator -parse-as-library KaChat/Utilities/ImagePrep.swift scripts/test_image_prep_avif_upload.swift -o /tmp/image_prep_avif_upload_test
